...
import { faHouse, faCircleCheck, faMicroscope, faChartColumn, faGear } from '@fortawesome/free-solid-svg-icons'
import type { IconDefinition } from '@fortawesome/fontawesome-svg-core'

const TABS: { href: string; label: string; icon: IconDefinition }[] = [
  { href: '/dashboard',          label: '홈',    icon: faHouse },
  { href: '/dashboard/calendar', label: '케어',   icon: faCircleCheck },
