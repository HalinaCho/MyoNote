(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,20414,44861,35254,62479,e=>{"use strict";var t=e.i(43476),r=e.i(71645);function a(e,t){return e?.treatments?e.treatments.filter(e=>(e.periods??[]).some(e=>e.s<=t&&(null==e.e||t<=e.e))):[]}function o(e,t,r){let a=[];for(let o of e){let e=t.find(e=>e.key===o.key),n=[...o.periods??[]],i=n.findIndex(e=>null==e.e);e&&i<0&&n.push({s:r,e:null}),!e&&i>=0&&(n[i]={...n[i],e:r}),a.push({...o,name:e?.name??o.name,schedule:e?.schedule??o.schedule,periods:n})}for(let o of t)e.some(e=>e.key===o.key)||a.push({key:o.key,name:o.name,preset:o.preset,schedule:o.schedule,periods:[{s:r,e:null}]});return a}e.s(["TREATMENT_PRESETS",0,[{preset:"atropine",name:"아트로핀 점안",schedule:"취침 전 1회"},{preset:"dreamlens",name:"드림렌즈",schedule:"취침 시"}],"getActiveTreatments",0,a,"makeTreatmentKey",0,function(){return`c_${crypto.randomUUID().slice(0,8)}`},"mergeTreatments",0,o],44861);var n=e.i(11795);let i=(e,t)=>e.some(e=>e.preset===t&&(e.periods??[]).some(e=>null==e.e));async function l(){let e=(0,n.createClient)(),{data:t,error:r}=await e.from("eyebody_child_guardians").select("role, eyebody_children(id, name, birth_date, gender, treatments, outdoor_goal, phone_goal)").order("created_at",{ascending:!0});if(r)throw r;return(t??[]).map(e=>({id:e.eyebody_children.id,name:e.eyebody_children.name,birth:e.eyebody_children.birth_date,gender:e.eyebody_children.gender,treatments:e.eyebody_children.treatments??[],role:e.role,outdoorGoal:e.eyebody_children.outdoor_goal??2,phoneGoal:e.eyebody_children.phone_goal??2}))}async function s(e){let t=(0,n.createClient)(),{data:{user:r}}=await t.auth.getUser();if(!r)throw Error("로그인이 필요합니다");let a=crypto.randomUUID(),{error:o}=await t.from("eyebody_children").insert({id:a,name:e.name,birth_date:e.birth,gender:e.gender,treatments:e.treatments,treat_atropine:i(e.treatments,"atropine"),treat_dreamlens:i(e.treatments,"dreamlens"),outdoor_goal:e.outdoorGoal??2,phone_goal:e.phoneGoal??2});if(o)throw o;let{error:l}=await t.from("eyebody_child_guardians").insert({child_id:a,user_id:r.id,role:"owner"});if(l)throw l;return{id:a,...e,outdoorGoal:e.outdoorGoal??2,phoneGoal:e.phoneGoal??2,role:"owner"}}async function d(e){let t=(0,n.createClient)(),{error:r}=await t.from("eyebody_children").update({name:e.name,birth_date:e.birth,gender:e.gender,treatments:e.treatments,treat_atropine:i(e.treatments,"atropine"),treat_dreamlens:i(e.treatments,"dreamlens"),outdoor_goal:e.outdoorGoal??2,phone_goal:e.phoneGoal??2}).eq("id",e.id);if(r)throw r}async function c(e){let t=(0,n.createClient)(),{error:r}=await t.from("eyebody_children").delete().eq("id",e);if(r)throw r}async function u(e){let t=(0,n.createClient)(),[r,a,o]=await Promise.all([t.from("eyebody_exam_records").select("id,exam_date,clinic,ax_od,ax_os,sph_od,sph_os,cyl_od,cyl_os,ser_od,ser_os,note,next_appointment").eq("child_id",e).order("exam_date",{ascending:!1}),t.from("eyebody_treatment_logs").select("log_date, done, atropine, dreamlens").eq("child_id",e),t.from("eyebody_activity_logs").select("log_date, outdoor_hours, phone_hours, sleep_hours").eq("child_id",e)]),i=(r.data??[]).map(e=>({id:e.id,date:e.exam_date,clinic:e.clinic??"",axOD:null!=e.ax_od?String(e.ax_od):"",axOS:null!=e.ax_os?String(e.ax_os):"",sphOD:null!=e.sph_od?String(e.sph_od):"",sphOS:null!=e.sph_os?String(e.sph_os):"",cylOD:null!=e.cyl_od?String(e.cyl_od):"",cylOS:null!=e.cyl_os?String(e.cyl_os):"",serOD:null!=e.ser_od?String(e.ser_od):"",serOS:null!=e.ser_os?String(e.ser_os):"",note:e.note??"",nextAppointment:e.next_appointment??""}));return{exams:i,logs:Object.fromEntries((a.data??[]).map(e=>{let t=e.done??{...e.atropine?{atropine:!0}:{},...e.dreamlens?{dreamlens:!0}:{}};return[e.log_date,t]})),lifestyle:Object.fromEntries((o.data??[]).map(e=>[e.log_date,{outdoor:parseFloat(e.outdoor_hours),phone:parseFloat(e.phone_hours),sleep:parseFloat(e.sleep_hours)}]))}}async function p(e,t,r){let a=(0,n.createClient)(),{error:o}=await a.from("eyebody_treatment_logs").upsert({child_id:e,log_date:t,done:r,atropine:!!r.atropine,dreamlens:!!r.dreamlens},{onConflict:"child_id,log_date"});if(o)throw o}async function f(e,t){let r=(0,n.createClient)(),a=t.sphOD?parseFloat(t.sphOD):null,o=t.sphOS?parseFloat(t.sphOS):null,i=t.cylOD?parseFloat(t.cylOD):null,l=t.cylOS?parseFloat(t.cylOS):null,{data:s,error:d}=await r.from("eyebody_exam_records").insert({child_id:e,exam_date:t.date,clinic:t.clinic||null,ax_od:t.axOD?parseFloat(t.axOD):null,ax_os:t.axOS?parseFloat(t.axOS):null,sph_od:a,sph_os:o,cyl_od:i,cyl_os:l,ser_od:null!=a?a+(i??0)/2:null,ser_os:null!=o?o+(l??0)/2:null,note:t.note||null,next_appointment:t.nextAppointment||null}).select().single();if(d)throw d;return{id:s.id,date:s.exam_date,clinic:s.clinic??"",axOD:null!=s.ax_od?String(s.ax_od):"",axOS:null!=s.ax_os?String(s.ax_os):"",sphOD:null!=s.sph_od?String(s.sph_od):"",sphOS:null!=s.sph_os?String(s.sph_os):"",cylOD:null!=s.cyl_od?String(s.cyl_od):"",cylOS:null!=s.cyl_os?String(s.cyl_os):"",serOD:null!=s.ser_od?String(s.ser_od):"",serOS:null!=s.ser_os?String(s.ser_os):"",note:s.note??"",nextAppointment:s.next_appointment??""}}async function m(e,t){let r=(0,n.createClient)(),a=t.sphOD?parseFloat(t.sphOD):null,o=t.sphOS?parseFloat(t.sphOS):null,i=t.cylOD?parseFloat(t.cylOD):null,l=t.cylOS?parseFloat(t.cylOS):null,{data:s,error:d}=await r.from("eyebody_exam_records").update({exam_date:t.date,clinic:t.clinic||null,ax_od:t.axOD?parseFloat(t.axOD):null,ax_os:t.axOS?parseFloat(t.axOS):null,sph_od:a,sph_os:o,cyl_od:i,cyl_os:l,ser_od:null!=a?a+(i??0)/2:null,ser_os:null!=o?o+(l??0)/2:null,note:t.note||null,next_appointment:t.nextAppointment||null}).eq("id",e).select().single();if(d)throw d;return{id:s.id,date:s.exam_date,clinic:s.clinic??"",axOD:null!=s.ax_od?String(s.ax_od):"",axOS:null!=s.ax_os?String(s.ax_os):"",sphOD:null!=s.sph_od?String(s.sph_od):"",sphOS:null!=s.sph_os?String(s.sph_os):"",cylOD:null!=s.cyl_od?String(s.cyl_od):"",cylOS:null!=s.cyl_os?String(s.cyl_os):"",serOD:null!=s.ser_od?String(s.ser_od):"",serOS:null!=s.ser_os?String(s.ser_os):"",note:s.note??"",nextAppointment:s.next_appointment??""}}async function h(e){let t=(0,n.createClient)(),{error:r}=await t.from("eyebody_exam_records").delete().eq("id",e);if(r)throw r}async function y(e,t,r){let a=(0,n.createClient)(),{error:o}=await a.from("eyebody_activity_logs").upsert({child_id:e,log_date:t,outdoor_hours:r.outdoor,phone_hours:r.phone,sleep_hours:r.sleep??0},{onConflict:"child_id,log_date"});if(o)throw o}async function g(e,t){let r=(0,n.createClient)(),{error:a}=await r.from("eyebody_activity_logs").delete().eq("child_id",e).eq("log_date",t);if(a)throw a}async function _(e){let t=(0,n.createClient)(),{data:r,error:a}=await t.rpc("get_child_guardians",{p_child_id:e});if(a)throw a;return(r??[]).map(e=>({userId:e.user_id,role:e.role,displayName:e.display_name||e.email?.split("@")[0]||"알 수 없음",email:e.email||""}))}async function x(e,t){let r=(0,n.createClient)(),{error:a}=await r.from("eyebody_child_guardians").delete().eq("child_id",e).eq("user_id",t);if(a)throw a}async function b(e="editor"){let t=(0,n.createClient)(),{data:{user:r}}=await t.auth.getUser();if(!r)throw Error("로그인이 필요합니다");let a=Math.random().toString(36).slice(2,8).toUpperCase(),{error:o}=await t.from("eyebody_invite_codes").insert({code:a,owner_id:r.id,role:e});if(o)throw o;return a}async function v(e){let t=(0,n.createClient)(),{data:{user:r}}=await t.auth.getUser();if(!r)throw Error("로그인이 필요합니다");let{data:a,error:o}=await t.from("eyebody_invite_codes").select("id, owner_id, role").eq("code",e.toUpperCase().trim()).is("used_at",null).gt("expires_at",new Date().toISOString()).single();if(o||!a)throw Error("유효하지 않은 코드입니다");if(a.owner_id===r.id)throw Error("자신의 초대 코드는 사용할 수 없습니다");let{data:i}=await t.from("eyebody_child_guardians").select("child_id").eq("user_id",a.owner_id).eq("role","owner");if(!i?.length)throw Error("초대자의 자녀 정보를 찾을 수 없습니다");let l=0;for(let{child_id:e}of i){let{data:o}=await t.from("eyebody_child_guardians").select("id").eq("child_id",e).eq("user_id",r.id).maybeSingle();!o&&(await t.from("eyebody_child_guardians").insert({child_id:e,user_id:r.id,role:a.role}),l++)}return await t.from("eyebody_invite_codes").update({used_at:new Date().toISOString(),used_by:r.id}).eq("id",a.id),l}function w(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`}function S(e){let[t,r,a]=e.split("-").map(Number);return new Date(t,r-1,a)}function C(){return w(new Date)}e.s(["acceptInviteCode",0,v,"addChild",0,s,"createInviteCode",0,b,"deleteChild",0,c,"deleteExam",0,h,"deleteLifestyle",0,g,"fetchChildData",0,u,"fetchChildren",0,l,"fetchGuardians",0,_,"removeGuardian",0,x,"saveExam",0,f,"saveLifestyle",0,y,"saveTreatmentLog",0,p,"updateChild",0,d,"updateExam",0,m],35254),e.s(["calcAgeLabel",0,function(e){let t;return`만 ${t=S(e),Math.floor((new Date().getTime()-t.getTime())/315576e5)}세`},"formatDate",0,w,"parseDate",0,S,"today",0,C],62479);let O=(0,r.createContext)(null);e.s(["ChildProvider",0,function({children:e}){let[n,i]=(0,r.useState)([]),[_,x]=(0,r.useState)(null),[b,v]=(0,r.useState)({}),[w,S]=(0,r.useState)([]),[j,E]=(0,r.useState)({}),[D,k]=(0,r.useState)(!0),N=(0,r.useCallback)(async e=>{let t=await u(e);v(t.logs),S(t.exams),E(t.lifestyle)},[]),P=(0,r.useCallback)(async()=>{k(!0);try{let e=await l();i(e);let t=localStorage.getItem("mn_active"),r=e.find(e=>e.id===t)?.id??e[0]?.id??null;x(r),r&&(localStorage.setItem("mn_active",r),await N(r))}finally{k(!1)}},[N]);(0,r.useEffect)(()=>{P()},[P]);let T=(0,r.useCallback)(async e=>{x(e),localStorage.setItem("mn_active",e),await N(e)},[N]),I=n.find(e=>e.id===_)??null,$=a(I,C()),A=(0,r.useCallback)(e=>a(I,e),[I]),F=async e=>{let t=o([],e.treatments,C()),r=await s({...e,treatments:t});i(e=>[...e,r]),await T(r.id)},L=async e=>{let t=n.find(t=>t.id===e.id),r=o(t?.treatments??[],e.treatments,C()),a={...e,treatments:r};await d(a),i(t=>t.map(t=>t.id===e.id?{...t,...a}:t))},M=async e=>{await c(e);let t=n.filter(t=>t.id!==e);if(i(t),_===e){let e=t[0]?.id??null;x(e),e?(localStorage.setItem("mn_active",e),await N(e)):(v({}),S([]),E({}))}},U=async(e,t)=>{_&&(v(r=>({...r,[e]:t})),await p(_,e,t))},R=e=>[...e].sort((e,t)=>t.date.localeCompare(e.date)),q=async e=>{if(!_)throw Error("자녀를 선택해주세요");let t=await f(_,e);return S(e=>R([t,...e])),t},z=async(e,t)=>{let r=await m(e,t);S(t=>R(t.map(t=>t.id===e?r:t)))},G=async e=>{await h(e),S(t=>t.filter(t=>t.id!==e))},K=async(e,t)=>{_&&(E(r=>({...r,[e]:t})),await y(_,e,t))},B=async e=>{_&&(await g(_,e),E(t=>{let r={...t};return delete r[e],r}))};return(0,t.jsx)(O.Provider,{value:{children:n,activeChildId:_,activeChild:I,activeTreatments:$,treatmentsForDate:A,logs:b,exams:w,lifestyle:j,isLoading:D,switchChild:T,refreshChildren:P,addChild:F,updateChild:L,deleteChild:M,saveTreatmentLog:U,saveExam:q,updateExam:z,deleteExam:G,saveLifestyle:K,deleteLifestyle:B},children:e})},"useChild",0,function(){let e=(0,r.useContext)(O);if(!e)throw Error("useChild must be used within ChildProvider");return e}],20414)},5766,e=>{"use strict";let t,r;var a,o=e.i(71645);let n={data:""},i=/(?:([\u0080-\uFFFF\w-%@]+) *:? *([^{;]+?);|([^;}{]*?) *{)|(}\s*)/g,l=/\/\*[^]*?\*\/|  +/g,s=/\n+/g,d=(e,t)=>{let r="",a="",o="";for(let n in e){let i=e[n];"@"==n[0]?"i"==n[1]?r=n+" "+i+";":a+="f"==n[1]?d(i,n):n+"{"+d(i,"k"==n[1]?"":t)+"}":"object"==typeof i?a+=d(i,t?t.replace(/([^,])+/g,e=>n.replace(/([^,]*:\S+\([^)]*\))|([^,])+/g,t=>/&/.test(t)?t.replace(/&/g,e):e?e+" "+t:t)):n):null!=i&&(n="-"==n[1]?n:n.replace(/[A-Z]/g,"-$&").toLowerCase(),o+=d.p?d.p(n,i):n+":"+i+";")}return r+(t&&o?t+"{"+o+"}":o)+a},c={},u=e=>{if("object"==typeof e){let t="";for(let r in e)t+=r+u(e[r]);return t}return e};function p(e){let t,r,a=this||{},o=e.call?e(a.p):e;return((e,t,r,a,o)=>{var n;let p=u(e),f=c[p]||(c[p]=(e=>{let t=0,r=11;for(;t<e.length;)r=101*r+e.charCodeAt(t++)>>>0;return"go"+r})(p));if(!c[f]){let t=p!==e?e:(e=>{let t,r,a=[{}];for(;t=i.exec(e.replace(l,""));)t[4]?a.shift():t[3]?(r=t[3].replace(s," ").trim(),a.unshift(a[0][r]=a[0][r]||{})):a[0][t[1]]=t[2].replace(s," ").trim();return a[0]})(e);c[f]=d(o?{["@keyframes "+f]:t}:t,r?"":"."+f)}let m=r&&c.g;return r&&(c.g=c[f]),n=c[f],m?t.data=t.data.replace(m,n):-1===t.data.indexOf(n)&&(t.data=a?n+t.data:t.data+n),f})(o.unshift?o.raw?(t=[].slice.call(arguments,1),r=a.p,o.reduce((e,a,o)=>{let n=t[o];if(n&&n.call){let e=n(r),t=e&&e.props&&e.props.className||/^go/.test(e)&&e;n=t?"."+t:e&&"object"==typeof e?e.props?"":d(e,""):!1===e?"":e}return e+a+(null==n?"":n)},"")):o.reduce((e,t)=>Object.assign(e,t&&t.call?t(a.p):t),{}):o,(e=>{if("object"==typeof window){let t=(e?e.querySelector("#_goober"):window._goober)||Object.assign(document.createElement("style"),{innerHTML:" ",id:"_goober"});return t.nonce=window.__nonce__,t.parentNode||(e||document.head).appendChild(t),t.firstChild}return e||n})(a.target),a.g,a.o,a.k)}p.bind({g:1});let f,m,h,y=p.bind({k:1});function g(e,t){let r=this||{};return function(){let a=arguments;function o(n,i){let l=Object.assign({},n),s=l.className||o.className;r.p=Object.assign({theme:m&&m()},l),r.o=/go\d/.test(s),l.className=p.apply(r,a)+(s?" "+s:""),t&&(l.ref=i);let d=e;return e[0]&&(d=l.as||e,delete l.as),h&&d[0]&&h(l),f(d,l)}return t?t(o):o}}var _=(e,t)=>"function"==typeof e?e(t):e,x=(t=0,()=>(++t).toString()),b=()=>{if(void 0===r&&"u">typeof window){let e=matchMedia("(prefers-reduced-motion: reduce)");r=!e||e.matches}return r},v="default",w=(e,t)=>{let{toastLimit:r}=e.settings;switch(t.type){case 0:return{...e,toasts:[t.toast,...e.toasts].slice(0,r)};case 1:return{...e,toasts:e.toasts.map(e=>e.id===t.toast.id?{...e,...t.toast}:e)};case 2:let{toast:a}=t;return w(e,{type:+!!e.toasts.find(e=>e.id===a.id),toast:a});case 3:let{toastId:o}=t;return{...e,toasts:e.toasts.map(e=>e.id===o||void 0===o?{...e,dismissed:!0,visible:!1}:e)};case 4:return void 0===t.toastId?{...e,toasts:[]}:{...e,toasts:e.toasts.filter(e=>e.id!==t.toastId)};case 5:return{...e,pausedAt:t.time};case 6:let n=t.time-(e.pausedAt||0);return{...e,pausedAt:void 0,toasts:e.toasts.map(e=>({...e,pauseDuration:e.pauseDuration+n}))}}},S=[],C={toasts:[],pausedAt:void 0,settings:{toastLimit:20}},O={},j=(e,t=v)=>{O[t]=w(O[t]||C,e),S.forEach(([e,r])=>{e===t&&r(O[t])})},E=e=>Object.keys(O).forEach(t=>j(e,t)),D=(e=v)=>t=>{j(t,e)},k={blank:4e3,error:4e3,success:2e3,loading:1/0,custom:4e3},N=e=>(t,r)=>{let a,o=((e,t="blank",r)=>({createdAt:Date.now(),visible:!0,dismissed:!1,type:t,ariaProps:{role:"status","aria-live":"polite"},message:e,pauseDuration:0,...r,id:(null==r?void 0:r.id)||x()}))(t,e,r);return D(o.toasterId||(a=o.id,Object.keys(O).find(e=>O[e].toasts.some(e=>e.id===a))))({type:2,toast:o}),o.id},P=(e,t)=>N("blank")(e,t);P.error=N("error"),P.success=N("success"),P.loading=N("loading"),P.custom=N("custom"),P.dismiss=(e,t)=>{let r={type:3,toastId:e};t?D(t)(r):E(r)},P.dismissAll=e=>P.dismiss(void 0,e),P.remove=(e,t)=>{let r={type:4,toastId:e};t?D(t)(r):E(r)},P.removeAll=e=>P.remove(void 0,e),P.promise=(e,t,r)=>{let a=P.loading(t.loading,{...r,...null==r?void 0:r.loading});return"function"==typeof e&&(e=e()),e.then(e=>{let o=t.success?_(t.success,e):void 0;return o?P.success(o,{id:a,...r,...null==r?void 0:r.success}):P.dismiss(a),e}).catch(e=>{let o=t.error?_(t.error,e):void 0;o?P.error(o,{id:a,...r,...null==r?void 0:r.error}):P.dismiss(a)}),e};var T=1e3,I=y`
from {
